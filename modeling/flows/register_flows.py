...
def register_flows():
    ...
    dataset_pipeline = periodic_monitoring_flow.to_deployment(
        ...
        cron=DATASET_SCHEDULE,
        tags=["dataset", "data preparation", "data collection"],
    )
    initial_training_flow()
    modeling_pipeline = periodic_retraining_flow.to_deployment(
