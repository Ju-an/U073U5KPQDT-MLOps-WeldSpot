...
def check_gpu_availability():
    try:
        ...
        warnings.warn(f"TensorFlow internal error while checking GPU availability: {e}", UserWarning)
        return []
    except Exception as e:
        warnings.warn(f"An unexpected error occurred while checking GPU availability: {e}", UserWarning)
        return None
