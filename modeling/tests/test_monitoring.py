...
expected_class_metrics = {
    "Background":           {"actuals": [1, 0, 1, 0, 1, 0], "predictions": [0.9, 0.2, 0.7, 0.4, 0.7, 0.4], "TP": 3, "FP": 0, "TN": 3, "FN": 0},
    "Bad Welding":          {"actuals": [0, 1, 0, 1, 1, 0], "predictions": [0.1, 0.8, 0.3, 0.6, 0.3, 0.4], "TP": 2, "FP": 0, "TN": 3, "FN": 1},
    "Crack":                {"actuals": [0, 0, 1, 0, 1, 0], "predictions": [0.2, 0.3, 0.6, 0.5, 0.6, 0.6], "TP": 2, "FP": 1, "TN": 3, "FN": 0},
    "Excess Reinforcement": {"actuals": [0, 1, 0, 1, 1, 0], "predictions": [0.3, 0.7, 0.4, 0.5, 0.1, 0.9], "TP": 1, "FP": 1, "TN": 2, "FN": 2},
    "Good Welding":         {"actuals": [0, 0, 1, 0, 1, 0], "predictions": [0.4, 0.4, 0.5, 0.3, 0.5, 0.4], "TP": 0, "FP": 0, "TN": 4, "FN": 2},
    "Porosity":             {"actuals": [0, 1, 0, 1, 1, 1], "predictions": [0.5, 0.6, 0.2, 0.7, 0.2, 0.9], "TP": 3, "FP": 0, "TN": 2, "FN": 1},
    "Splatters":            {"actuals": [0, 0, 1, 0, 0, 0], "predictions": [0.6, 0.5, 0.8, 0.2, 0.8, 0.2], "TP": 1, "FP": 2, "TN": 3, "FN": 0}
}
